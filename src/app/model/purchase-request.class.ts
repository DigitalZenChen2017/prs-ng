...
export class PurchaseRequest {
  ...
  constructor(id: number, prUser: User, description: string, justification: string, dateNeeded: Date, deliveryMode: string, status: string, total: number, submittedDate: Date, reasonForRejection: string) {
    this.id = id;
    this.user = prUser;
